...
export class LoginPage extends BasePage {
     ...
     */
    async isRecoveryEmailInputVisible() {
        try {
     ...
     */
    async isBackToLoginLinkVisible(linkText) {
        try {
     ...
     */
    async checkFieldType(fieldName, expectedType) {
     ...
     */
    async enterRecoveryEmail(email) {
