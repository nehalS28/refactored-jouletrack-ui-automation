 ...
 */
function generateFeatureFile(featureName, domain, outputDir) {
 ...
 */
function generateStepsFile(featureName, domain, outputDir) {
    const kebabName = toKebabCase(featureName);
 ...
 */
export function generateFeature(name, domain = 'shared', options = {}) {
 ...
 */
export function createGenerateFeatureCommand() {
