 ...
 */
function generateFeatureFile(domain: string, outputDir: string): string {
 ...
 */
function generateStepsFile(domain: string, outputDir: string): string {
 ...
 */
function generatePageFile(domain: string, outputDir: string): string {
 ...
 */
function generateLocatorFile(domain: string, outputDir: string): string {
 ...
 */
export function createGenerateDomainCommand(): Command {
