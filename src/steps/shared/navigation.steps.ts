 ...
 * @requirements 8.5
 */
Given('the application is running', async function (this: { context: TestContext }) {
 ...
 * @requirements 8.5, 9.2
 */
When('I navigate to {string}', async function (this: { context: TestContext }, path: string) {
  const baseUrl = this.context.config.baseUrl ?? '';
 ...
 * @requirements 8.5, 9.2
 */
When('I go to the {string} page', async function (this: { context: TestContext }, pageName: string) {
 ...
 * @requirements 8.5, 9.2
 */
Then('I should be on the {string} page', async function (this: { context: TestContext }, pageName: string) {
 ...
 * @requirements 8.5, 9.2
 */
Then('I should be redirected to the {string}', async function (this: { context: TestContext }, pageName: string) {
  const currentUrl = await this.context.driver.getCurrentUrl();
 ...
 * @requirements 8.5, 9.2
 */
Then('I should remain on the {string} page', async function (this: { context: TestContext }, pageName: string) {
  const currentUrl = await this.context.driver.getCurrentUrl();
  expect(currentUrl).toContain(pageName.toLowerCase());
});
 ...
 * @requirements 8.5, 9.2
 */
When('I go back', async function (this: { context: TestContext }) {
 ...
 * @requirements 8.5, 9.2
 */
When('I go forward', async function (this: { context: TestContext }) {
 ...
 * @requirements 8.5, 9.2
 */
When('I refresh the page', async function (this: { context: TestContext }) {
 ...
 * @requirements 8.5, 9.2
 */
When('I return to the {string} page', async function (this: { context: TestContext }, pageName: string) {
  const pathMap: Record<string, string> = {
    'login': '/login',
    'dashboard': '/dashboard',
    'reports': '/reports',
